...
Charlotte.Modelling %>%  
  ...
  ggplot(aes(Value, price)) +
      ...
      labs(title = "Home Price & Distance to the (1st/2nd/3rd) Nearest Homicide", subtitle = "Mecklenburg County, NC") +
      xlab("Distance (in ft.)") +
      ylab("Home Price") +
...
Charlotte.Modelling %>%  
  ...
  ggplot(aes(Value, price)) +
      ...
      geom_smooth(method = "lm", se=F, color = "black") +
      facet_wrap(~Variable, nrow = 1, scales = "free") +
      labs(title = "Home Price & Distance to the (1st/2nd/3rd) Nearest Incident", subtitle = "Mecklenburg County, NC") +
      xlab("Distance (in ft.)") +
      ylab("Home Price") +
  theme(strip.text.x = element_text(size = 3)) +
  plotTheme()
...
Charlotte.Modelling %>%  
  ...
  ggplot(aes(Value, price)) +
      ...
      facet_wrap(~Variable, nrow = 1, scales = "free") +
      labs(title = "Home Price & Distance to the (1st/2nd/3rd) Nearest Shop", subtitle = "Mecklenburg County, NC") +
      xlab("Distance (in ft.)") +
      ylab("Home Price") +
  theme(strip.text.x = element_text(size = 3)) +
  plotTheme()
...
Charlotte.Modelling %>%  
  ...
  ggplot(aes(Value, price)) +
      ...
      geom_smooth(method = "lm", se=F, color = "dark grey") +
      facet_wrap(~Variable, nrow = 1, scales = "free") +
      labs(title = "Home Price & Distance to the (1st/2nd/3rd) School", subtitle = "Mecklenburg County, NC") +
      xlab("Distance (in ft.)") +
      ylab("Home Price") +
  theme(strip.text.x = element_text(size = 3)) +
  plotTheme()
...
ggplot() + 
  ...
  geom_sf(data = Charlotte.Modelling, aes(color = q5(school.Buffer)), show.legend = "point", size = .1) +
    ...
    labs(title = "Number of Schools Within 1 Mile Buffer", subtitle = "Mecklenburg County, NC", aes(color= "pink")) +
                          mapTheme()
...
ggplot() + 
  ...
  geom_sf(data = Charlotte.Modelling, aes(color = q5(shop_nn1)), show.legend = "point", size = .1) +
    ...
    labs(title = "Distance to the Nearest Shop (Independent Variable 2)", subtitle = "Mecklenburg County, NC") +
                          mapTheme()
...
ggplot() + 
  ...
  geom_sf(data = Charlotte.Modelling, aes(color=landusecod), show.legend = "point", size = .1) +
    labs(title = "Land Use Code (Inependent Variable)", subtitle = "Mecklenburg County, NC") +
                          mapTheme()
