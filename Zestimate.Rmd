---
title: 'Regrestimate: Predicting Charlotte, NC Home Sale Prices with OLS Regression'
...
Rogers](<https://images.unsplash.com/photo-1539304180102-10f854c3585e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1442&q=80>[)](https://timesofsandiego.com/wp-content/uploads/2021/02/MTS-Trolley-Downtown.jpg))
...
reg.training%>%
  tidy()%>%
  kable(
    caption = "<center><strong>Additional Regression Variables</strong></center>",
    escape= FALSE,
    format="html")%>%
...
st_join(bothRegressions, tracts20) %>% 
  ...
  kable(caption = "Test set MAPE within Neighborhood Income Context")%>%
  kable_styling()
