...
write.csv(Charlotte.Prediction,"RegressToImpress_Prediction.csv", row.names = FALSE)
         



predChallenge <- predict(reg.nhood, Charlotte.Challenge)
